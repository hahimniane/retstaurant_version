...
class _MenuState extends State<Menu> {
  ...
  final TextEditingController photo = new TextEditingController();
  ...
  final TextEditingController ingredientOne = new TextEditingController();
  final TextEditingController ingredientTwo = new TextEditingController();
  final TextEditingController ingredientThree = new TextEditingController();
  late int imageType;
          ...
          children: [
            Expanded(
              ...
              child: GridView(
                ...
                children: [
                  buildCard('images/pizza.png', 'Pizza', 'lorem ipsum is the stander testing text', '1000'),
                  buildCard('images/burger.png', 'Pizza', 'lorem ipsum is the stander testing text', '900'),
                  buildCard('images/plate.png', 'Pizza', 'lorem ipsum is the stander testing text', '1200'),
                  buildCard('images/noodle.png', 'Pizza', 'lorem ipsum is the stander testing text', '300'),
                  buildCard('images/kfc.png', 'Pizza', 'lorem ipsum is the stander testing text', '2500'),
                  buildCard('images/chicken.png', 'Pizza', 'lorem ipsum is the stander testing text', '500'),
                  buildCard('images/shawarma.png', 'Pizza', 'lorem ipsum is the stander testing text', '700'),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Expanded(flex: 4,child: ingredientOneField),
                                        Expanded(flex: 1, child: IconButton(icon: const Icon(Icons.plus_one), onPressed: (){},))
                                      ],
                                    ),
                                    ElevatedButton(
                                        onPressed: () async {
                                    ...
                                    Expanded(child: Padding(
                                        padding: const EdgeInsets.symmetric(vertical: 18.0,horizontal: 1.0),
                                        child: SaveButton,
                                        ),
                                    )
                                    // SizedBox(
